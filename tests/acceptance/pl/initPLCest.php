...
class initPLCest
{
    ...
    protected function executeQuery($I)
    {
        ...
        $query      = "SELECT a.*, to_char(DATE_OF_BIRTH, 'MM/DD/YYYY') AS DATE_OF_BIRTH FROM AUTOMATION_TEST_CASE_PL a WHERE SUB_SEGMENT = 'NTB_S2' AND IS_RUN = 0 AND HOMETOWN <> 'Tỉnh Đắk Lắk'";
