...
(
       ...
       score_group                    VARCHAR2(3)   DEFAULT 0,
       random_number                  NUMBER(3)     DEFAULT 0,
       /* Scores are defined by user */
       score_user_gender_and_age      NUMBER(3)     DEFAULT 0,
       score_user_marital_status      NUMBER(3)     DEFAULT 0,
       score_user_installment         NUMBER(3)     DEFAULT 0,
       score_user_pos_region          NUMBER(3)     DEFAULT 0,
       score_user_cc_performance      NUMBER(3)     DEFAULT 0,
       score_user_fb_owner            NUMBER(3)     DEFAULT 0,
       score_user_down_payment_ratio  NUMBER(3)     DEFAULT 0,
       score_user_pos_performance     NUMBER(3)     DEFAULT 0,
       score_user_owner_dpd_ever      NUMBER(3)     DEFAULT 0,
       score_user_ref_dpd             NUMBER(3)     DEFAULT 0,
       score_user_owner_rejected      NUMBER(3)     DEFAULT 0,
       score_user_owner_disbursed     NUMBER(3)     DEFAULT 0,
       score_user_asset_brand         NUMBER(3)     DEFAULT 0,
       score_user_effective_rate      NUMBER(3)     DEFAULT 0,
       score_user_document_required   NUMBER(3)     DEFAULT 0,
