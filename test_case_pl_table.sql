...
(
       ...
       /* Checking score */
       score_check_age                           NUMBER(3),
       score_check_cic_relationship              NUMBER(3),
       score_check_company                       NUMBER(3),
       score_check_pre_of_work_exp               NUMBER(3),
       score_check_cust_social_trust             NUMBER(3),
       score_check_disb_apps                     NUMBER(3),
       score_check_dsa                           NUMBER(3),
       score_check_education                     NUMBER(3),
       score_check_gender                        NUMBER(3),
       score_check_marital_status                NUMBER(3),
       score_check_hometown                      NUMBER(3),
       score_check_rejected_apps                 NUMBER(3),
       score_check_ts_apply_days                 NUMBER(3),
       check_total_score                         NUMBER(3),
       check_score_group                         VARCHAR2(3),
       check_product_score_group                 VARCHAR2(4),
       check_sub_segment                         VARCHAR(10),
       check_lead_black                          VARCHAR(10),
       /* Checking status */
